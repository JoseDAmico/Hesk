...
$hesk_settings['site_url']='https://automationui.academy';
$hesk_settings['hesk_title']='My help desk';
$hesk_settings['hesk_url']='https://automationui.academy/hesk';
$hesk_settings['webmaster_mail']='jose@automationui.com';
...
'Español' => array('folder'=>'es','hr'=>'------ Responder sobre esta línea ------'),
'English' => array('folder'=>'en','hr'=>'------ Reply above this line ------'),
);

// --> Database settings
$hesk_settings['db_host']='localhost';
$hesk_settings['db_name']='automat0_hesk1';
$hesk_settings['db_user']='automat0_hesk1';
$hesk_settings['db_pass']='0SW.xp(75w';
$hesk_settings['db_pfix']='heskvk_';
...
$hesk_settings['secimg_sum']='MB99ZNASXE';
...
$hesk_settings['question_ask']='Which of these is an animal: ball, money, pig';
$hesk_settings['question_ans']='pig';
...
$hesk_settings['url_key']='fA5a0rrevwp5ws.hcc2s';
...
// --> Email sending
$hesk_settings['noreply_mail']='jose@automationui.com';
